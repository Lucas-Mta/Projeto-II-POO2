...
public class AdminHelpScreen extends JDialog {
    ...
    public AdminHelpScreen(JFrame parent) {
    ...
    private JPanel createHelpCard(int index) {
        ...
        imagePanel.setPreferredSize(new Dimension(0, 150)); // Altura fixa de 150 pixels
        ...
        for (String fileName : imageFiles) {
            ...
            imageWrapper.setBorder(BorderFactory.createEmptyBorder(0, 5, 0, 5));
    ...
    private void setupActions() {
        ...
        backButton.addActionListener(e -> {
            dispose(); // Closes the help window
            new AdminScreen(); // Opens a new admin screen
        });
    }
